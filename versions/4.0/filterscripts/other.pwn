...
public OnFilterScriptInit()
{
	...
	actor[63] = CreateActor(102, 1773.4946,-1895.7144,13.5508,88.9433);
	actor[64] = CreateActor(152, 2535.0120,-1474.6285,24.0034,359.4227);
	...
	actor[259] = CreateActor(28, 1110.7767, -1423.8966, 15.7969, 245.5061);
    ...
    CreateDynamic3DTextLabel("{8000FF}Смурф\n{FFFFFF}Нажмите ALT",COLOR_VALIK,1773.4946,-1895.7144,13.5508,8.0);
    //цыба
    ...
    CreateDynamic3DTextLabel("Шлагбаум.\nСтоимость проезда: {9ACD32}100000$\n{FFFFFF}Открыть: {9ACD32}H",-1,-2154.1677,-745.3832,32.0234,5.0);
    CreateDynamic3DTextLabel("Шлагбаум.\nСтоимость проезда: {9ACD32}100000$\n{FFFFFF}Открыть: {9ACD32}H",-1,355.0979,-1787.9756,5.2749,5.0);
	...
	CreateDynamic3DTextLabel("Компьютер для редакции объявлений\n{73B461}[ALT]",-1,1540.2184,1947.6786,1020.9574,2.0);
	CreateDynamic3DTextLabel("Компьютер для редакции объявлений\n{73B461}[ALT]",-1,1540.2268,1951.6934,1020.9574,2.0);
	...
	//новая ферма
	CreateDynamic3DTextLabel("{CCCCCC}грядка: морковь\nчто-бы собрать\n{FFFFFF} [  ALT  ]",COLOR_BLUENEW,-459.9506,-1599.3918,10.5195,6.0);
	CreateDynamic3DTextLabel("{CCCCCC}грядка: чай\nчто-бы собрать\n{FFFFFF} [  ALT  ]",COLOR_BLUENEW,-459.4090,-1607.8867,10.2490,6.0);
	CreateDynamic3DTextLabel("{CCCCCC}грядка: картофель\nчто-бы собрать\n{FFFFFF} [  ALT  ]",COLOR_BLUENEW,-459.1610,-1615.8834,9.9423,6.0);
	//болька
	CreateDynamic3DTextLabel("{CCCCCC}Быстрое лечение\nВоспользуйтесь\n{FF0000}[ ALT ]{FFFFFF}",COLOR_BLUENEW,1151.8339,-1308.4961,1019.4307,30);
	//
	...
	//смит
	CreateDynamic3DTextLabel("{73B461}Барыга\nПокупка новых анти талонов\n{FFFFFF}[  ALT  ]",COLOR_BLUENEW,-802.5646,2828.3745,1501.9896,3.0);
	...
	CreatePickup(1275,23,2269.6865,1446.0717,1008.7613,-1);
    CreateDynamic3DTextLabel("Раздевалка\n{FFFFFF}ALT",COLOR_ORANGE,2269.6865,1446.0717,1008.7613,8.0); //казик
    CreatePickup(1550,23,2270.1467,1442.7574,1008.7613,-1);
    CreateDynamic3DTextLabel("Зарплата\n{FFFFFF}ALT",COLOR_ORANGE,2270.1467,1442.7574,1008.7613,8.0);
    ...
    CreateDynamic3DTextLabel("Подать объявление\n{73B461}Используйте: /ad", -1, 1538.4250,1949.6934,1020.9574, 3.0);
	...
	CreateDynamicMapIcon(2052.2061,-2150.2756,13.6329, 23, 0, -1, -1, -1, 300.0);//АРЕНА
	...
	//КАЗИНО ДМГ
	CreateDynamic3DTextLabel("{F5DEB3}[{FFFFFF} Орёл и Решка {00ff00}(На Вирты){F5DEB3}]{FFFFFF}\n{AFAFAF}/orel [ид] [сумма]\n\t{FFFFFF}или\n{AFAFAF}/reshka [ид] [сумма]\n\n{FFFFFF}Отменить ставку:{AFAFAF} or_cancel{FFFFFF}\n\n{F5DEB3}[{FFFFFF} Орёл и Решка {ff0000}(На Евро){F5DEB3}]{FFFFFF}\n{AFAFAF}/e_orel [ид] [сумма]\n\t{FFFFFF}или\n{AFAFAF}/e_reshka [ид] [сумма]\n\n{FFFFFF}Отменить ставку:{AFAFAF} e_cancel{FFFFFF}",-1,-811.7739,2831.0059,1503.0256,6.0);
    //
    CreateDynamic3DTextLabel("{F5DEB3}[{FFFFFF} Орёл и Решка {00ff00}(На Вирты){F5DEB3}]{FFFFFF}\n{AFAFAF}/orel [ид] [сумма]\n\t{FFFFFF}или\n{AFAFAF}/reshka [ид] [сумма]\n\n{FFFFFF}Отменить ставку:{AFAFAF} or_cancel{FFFFFF}\n\n{F5DEB3}[{FFFFFF} Орёл и Решка {ff0000}(На Евро){F5DEB3}]{FFFFFF}\n{AFAFAF}/e_orel [ид] [сумма]\n\t{FFFFFF}или\n{AFAFAF}/e_reshka [ид] [сумма]\n\n{FFFFFF}Отменить ставку:{AFAFAF} e_cancel{FFFFFF}",-1,2165.1284,2396.0361,1072.1885,6.0);
    CreateDynamic3DTextLabel("{F5DEB3}[{FFFFFF} Орёл и Решка {00ff00}(На Вирты){F5DEB3}]{FFFFFF}\n{AFAFAF}/orel [ид] [сумма]\n\t{FFFFFF}или\n{AFAFAF}/reshka [ид] [сумма]\n\n{FFFFFF}Отменить ставку:{AFAFAF} or_cancel{FFFFFF}\n\n{F5DEB3}[{FFFFFF} Орёл и Решка {ff0000}(На Евро){F5DEB3}]{FFFFFF}\n{AFAFAF}/e_orel [ид] [сумма]\n\t{FFFFFF}или\n{AFAFAF}/e_reshka [ид] [сумма]\n\n{FFFFFF}Отменить ставку:{AFAFAF} e_cancel{FFFFFF}",-1,1711.8809,2050.9143,1014.2481,6.0);
    //
    //
	...
	//тюнинг салон лв новый
	Create3DTextLabel("[ Информация о работе салона ]\n{cccccc}Нажмите ALT", 0xFFFFFFFF, 2571.3157, 978.1287, 10.9932, 7.5000, 5,0);
	CreatePickup(1239, 23, 2571.3157, 978.1287, 10.9932, -1);
	Create3DTextLabel("[ Бокс 1 ]\n{FFFFFF}[ В каждом боксе разные товары ]\n{cccccc}Нажмите H", 0xFFFFFFFF, 2578.1338,985.1371,11.0662, 5,0);
	Create3DTextLabel("[ Бокс 2 ]\n{FFFFFF}[ В каждом боксе разные товары ]\n{cccccc}Нажмите H", 0xFFFFFFFF, 2577.7808,989.4241,11.0490, 5,0);
	Create3DTextLabel("[ Бокс 3 ]\n{FFFFFF}[ В каждом боксе разные товары ]\n{cccccc}Нажмите H", 0xFFFFFFFF, 2577.8860,994.5915,11.0541, 5,0);
	CreatePickup(1239, 23, 2578.1338,985.1371,11.0662, -1);
	CreatePickup(1239, 23, 2577.7808,989.4241,11.0490, -1);
	CreatePickup(1239, 23, 2577.8860,994.5915,11.0541, -1);
	//пикап кран новый
	CreatePickup(1239, 23, -1724.7922,38.9815,3.5489, -1);
	Create3DTextLabel("[ Информация о работе ]\n{cccccc}Нажмите ALT", 0xFFFFFFFF, -1724.7922,38.9815,3.5489, 5,0);
	CreatePickup(1275, 23, -1726.2122,41.1838,3.5745, -1);
	CreateDynamic3DTextLabel(" Раздевалка \n\n{FFFFFF}Встаньте на пикап чтобы переодеться", COLOR_LIME, -1726.2122,41.1838,3.5745, 7.0);
	CreateDynamicMapIcon(-1726.2122,41.1838,3.5745, 51, 0, -1, -1, -1, 300.0);//
	//пикап дальнабой
	CreateDynamicMapIcon(-2285.6958,259.8932,35.3414, 51, 0, -1, -1, -1, 300.0);//
    Create3DTextLabel("{FFFF00}[ Информация о транспорте и грузах ]\n{cccccc}Нажмите ALT", 0xFFFFFFFF, -2285.6958,259.8932,35.3414, 5,0);
    CreatePickup(1239, 23, -2285.6958,259.8932,35.3414, -1);
    CreateDynamic3DTextLabel(" Начать работу\n\n{FFFFFF}[ Нажмите ALT ]", COLOR_LIME, -2277.3193,257.8130,35.3345, 7.0);
    CreatePickup(1275, 23, -2277.3193,257.8130,35.3345, -1);
	Create3DTextLabel("{FFFF00}[ Взять грузовик ]\n{cccccc}Нажмите ALT", 0xFFFFFFFF, -2280.3794,257.6809,35.3345, 5,0);
    CreatePickup(1239, 23, -2280.3794,257.6809,35.3345, -1);
    //пикап новый салон
    Create3DTextLabel("[ Информация о салоне ]\n{cccccc}Нажмите ALT", 0xFFFFFFFF, 334.1623,-1806.9127,4.5340, 5,0);
    CreatePickup(1239, 23, 334.1623,-1806.9127,4.5340, -1);
    CreateDynamicMapIcon(334.1623,-1806.9127,4.5340, 51, 0, -1, -1, -1, 300.0);//
    //пикап покупки аксов
    Create3DTextLabel("{FFFF00}[ Покупка новых Аксессуаров ]\n{cccccc}Нажмите ALT", 0xFFFFFFFF, 1780.6244,-1887.3420,13.3898, 5,0);
    CreatePickup(1274, 23, 1780.6244,-1887.3420,13.3898);
	//Газона касилка
	CreatePickup(1239, 23, 1871.9951,-1172.4976,23.8281, -1);
	//Филатов
	actor[64] = CreateActor(134, 334.1606,-1808.5813,4.6678,1.7299);//филатов
	Create3DTextLabel("{FF0000}[ Филатов ]", 0xFFFFFFFF, 334.1606,-1808.5813,4.6678, 5,0);
	//Пикапы ресекты
	CreatePickup(1274, 23, 1816.3499,-1925.9473,13.5463);//1
	CreatePickup(1274, 23, 1966.3683,-2006.8195,13.3828);//2
	CreatePickup(1274, 23, 2394.0913,-1754.2172,13.3828);//3
	CreatePickup(1274, 23, 2207.6638,-1485.3955,23.8140);//4
	CreatePickup(1274, 23, 2637.8030,-1420.2397,30.2881);//5
    CreatePickup(1274, 23, 2426.1150,-1630.3094,27.4223);//6
    //пикап Продажа нелегальных
    Create3DTextLabel("{FF0000}[ Продажа нелегальных предметов ]\n{FFFF00}Нажмите ALT", 0xFFFFFFFF, 2534.6057,-1472.7185,24.0010, 5,0);
    CreatePickup(1274, 23, 2534.6057,-1472.7185,24.0010);
	//квартиры
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.4551, -1612.1427, 65.0058, 1.5000, 0, 1); //6 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.5512, -1612.0074, 69.5069, 1.5000, 0, 1); //7 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.4264, -1611.9918, 74.0000, 1.5000, 0, 1); //8 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.4467, -1612.1876, 78.5000, 1.5000, 0, 1); //9 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.3831, -1612.1304, 83.0000, 1.5000, 0, 1); //10 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.4050, -1612.1985, 87.5000, 1.5000, 0, 1); //11 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.3895, -1611.9766, 92.0000, 1.5000, 0, 1); //12 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.4732, -1611.9945, 96.5000, 1.5000, 0, 1); //13 этаж в лс товер
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 287.3877, -1612.0686, 33.0933, 1.5000, 0, 1); //1 этаж в лс товер
	//
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 1786.7188, -1300.6985, 54.7763, 1.5000, 0, 1); //8 этаж в сигнатуре
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 1786.6364, -1300.7655, 65.6826, 1.5000, 0, 1); //9 этаж в сигнатуре
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 1786.6763, -1300.7570, 76.5825, 1.5000, 0, 1); //10 этаж в сигнатуре
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 1786.6766, -1300.5983, 87.5228, 1.5000, 0, 1); //11 этаж в сигнатуре
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 1786.7001, -1300.6649, 98.4290, 1.5000, 0, 1); //12 этаж в сигнатуре
	Create3DTextLabel("{ffff00}[Выбор этажа]\n{cccccc}Нажмите ALT", 0xFFFFFF90, 1786.7737, -1300.6052, 13.5546, 1.5000, 0, 1); //1 этаж в сигнатуре
	Create3DTextLabel("Информация о квартирах\n\n{cccccc}[ Нажмите ALT ]", 0xFFFF00FF, 280.4361, -1607.8396, 33.1133, 5.0000, 0, 0); //в лс товер
	CreatePickup(1239, 1, 280.4361, -1607.8396, 33.1133, -1); //в лс товер
	Create3DTextLabel("Вход в уборную\n\n{cccccc}[ ALT ]", 0xFFFF00FF, 284.3001, -1604.5356, 33.0983, 5.0000, 0, 0); //в лс товер
	CreatePickup(1239, 1, 284.3001, -1604.5356, 33.0983, -1); //в лс товер
	Create3DTextLabel("Выкинуть мусор\n\n{cccccc}[ ALT ]", 0xFFFF00FF, 300.5960, -1613.0403, 33.1428, 5.0000, 0, 0); //в лс товер
	CreatePickup(1239, 23, 300.5960, -1613.0403, 33.1428, -1); //в лс товер
	Create3DTextLabel("Выкинуть мусор\n\n{cccccc}[ ALT ]", 0xFFFF00FF, 1773.0658, -1302.5137, 13.6220, 5.0000, 0, 0); //в сигнатуре
	CreatePickup(1239, 23, 1773.0658, -1302.5137, 13.6220, -1); //в сигнатуре
	Create3DTextLabel("Информация о квартирах\n\n{cccccc}[ Нажмите ALT ]", 0xFFFF00FF, 1793.6145, -1303.1317, 13.6498, 5.0000, 0, 0); //в сигнатуре
	CreatePickup(1239, 1, 1793.6145, -1303.1317, 13.6498, -1); //в сигнатуре
	...
	CreateDynamic3DTextLabel("Бар",-1,2163.2500,2433.9419,1071.1719,20.0);
	CreateDynamic3DTextLabel("Бар",-1,1728.2471,2023.3098,1013.4305,20.0);
	...
	//Школа танцев
    Create3DTextLabel("Рейдж ( Тренер по танцам )\n{FFFFFF}Чтобы поговорить нажми ALT", 0x73B461FF, 1756.8765, -315.1113, 1654.5055, 5.0000, 3, 3);
	Create3DTextLabel("Школа Танцев\n{FFFFFF}ALT", 0xAFAFAFFF, 1754.9205, -316.1614, 1655.5055, 5.0000, 3, 3);
    actor[261] = CreateActor(5, 1756.8765, -315.1113, 1654.5055, 359.2938);
    SetActorVirtualWorld(actor[261], 305);
	actor[262] = CreateActor(223, 1751.3000, -304.0993, 1654.5376, 181.1334);
	SetActorVirtualWorld(actor[262], 305);
	actor[263] = CreateActor(180, 1756.9268, -304.4160, 1654.5376, 177.3654);
	SetActorVirtualWorld(actor[263], 305);
	actor[264] = CreateActor(13, 1762.1881, -311.2039, 1654.5376, 179.9556);
	SetActorVirtualWorld(actor[264], 305);
	actor[265] = CreateActor(2, 1756.8878, -311.2824, 1654.5376, 179.7938);
	SetActorVirtualWorld(actor[265], 305);
	actor[266] = CreateActor(101, 1751.4460, -310.9987, 1654.5376, 178.7493);
	SetActorVirtualWorld(actor[266], 305);
	actor[267] = CreateActor(65, 1762.1881, -307.8369, 1654.5376, 179.9556);
	SetActorVirtualWorld(actor[267], 305);
	//райдер на груве
	CreateActor(271,2463.9580,-1689.3148,13.5154,317.0592);
	//новый черный рынок
    CreatePickup(1239, 1, 2886.4087,-2122.2021,3.7376, -1);//почта
    CreateActor(26, 2871.3499,-2127.0278,4.6653,283.4583);//барыга
   	Create3DTextLabel("{CCCCCC}Эдуард\nМестный барыга\n[ ALT ]", 0xFFFF00FF, 2871.3499,-2127.0278,4.6653, 10,0);//барыга
	Create3DTextLabel("{FFFFFF}Полка с письмами\n{FF0000}[alt]", 0xFFFF00FF, 2886.4087,-2122.2021,3.7376, 10,0);//почта
    // ларьки через ALY
    CreatePickup(2663, 23, 1771.0034, -1902.5177, 13.5557, -1);
    CreatePickup(2663, 23, -103.7395,-310.0467,1.4297,-1);
    CreatePickup(2663, 23, 1502.1321,-1279.6311,14.5651,-1);
    CreatePickup(2663, 23, 1433.6545,-1738.7367,13.5469,-1);
    CreatePickup(2663, 23, 2405.9805,-1933.0472,13.5538,-1);
    CreatePickup(2663, 23, 1184.5985,-1315.1580,13.5720,-1);
    CreatePickup(2663, 23, 1748.5256,-1922.6953,2001.0000,-1);
    CreatePickup(2663, 23, 195.4181,-115.9060,1.5500,-1);
    CreatePickup(2663, 23, 214.4591,-247.0783,1.9079,-1);
    CreatePickup(2663, 23, -2022.6366,460.3604,35.1723,-1);
    CreatePickup(2663, 23, 1105.0247,1379.9026,10.8203,-1);
    CreatePickup(2663, 23, 1574.4995,1844.3917,10.8203,-1);
    CreatePickup(2663, 23, 2030.1499,987.5954,10.8203,-1);
    CreatePickup(2663, 23, 2327.8806,2420.2002,10.8203,-1);
    CreatePickup(2663, 23, 2351.5396,2406.6335,10.8203,-1);
    CreatePickup(2663, 23, 2536.7700,2137.0681,10.8203,-1);
    CreatePickup(2663, 23, 2600.4695,1060.3147,10.8125,-1);
    CreatePickup(2663, 23, 2244.9023,570.9419,7.7802,-1);
    CreatePickup(2663, 23, 157.5782,-1812.6079,3.7416,-1);
    CreatePickup(2663, 23, 2221.0222,-1149.9821,25.7730,-1);
    CreatePickup(2663, 23, 1382.1482,-1804.9459,13.5469,-1);
    CreatePickup(2663, 23, -87.3811,100.6966,3.1172,-1);
    CreatePickup(2663, 23, -1290.5806,2366.1538,865.3589,-1);
    CreatePickup(2663, 23, -2399.1362,336.8928,35.1719,-1);
    CreatePickup(2663, 23, -2681.2913,584.9332,14.4531,-1);
    CreatePickup(2663, 23, -1984.5005,127.6157,27.6875,-1);
    CreatePickup(2663, 23, -1982.6625,174.4855,27.6799,-1);
    CreatePickup(2663, 23, -1549.8600,673.9366,7.1875,-1);
    CreatePickup(2663, 23, -1825.6996,-567.4372,16.4844,-1);
    CreatePickup(2663, 23,  1135.8530,-1456.5402,15.7969,-1);
    CreatePickup(2663, 23,  1143.7935,-1472.9805,15.7969,-1);
    CreatePickup(2663, 23,  1123.9476,-1467.5033,15.7572,-1);
	return 1;
}
